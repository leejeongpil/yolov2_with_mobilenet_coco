...
#import tensorflow.layers.separable_conv2d
...
class DetectNet(metaclass=ABCMeta):
    ...
    def predict(self, sess, dataset, verbose=False, **kwargs):
        ...
        for i in range(num_steps + flag):
            ...
            print(time.time() - bat_start)

        print('Total(sec): {}'.format(time.time() - start_time))
        if verbose:
...
class YOLO(DetectNet):
    ...
    def _build_model(self, **kwargs):
        ...
        # print("test start")
        #conv_test = conv_layer(X_input, 3, 1, 32,
                                   # padding='SAME', use_bias=False, weights_stddev=0.01)
        # separable_test = tf.layers.separable_conv2d(X_input, 32, (3,3), padding='SAME',
        #                                             use_bias=False)
        # print(separable_test)
        
        # print("test finish")
        #conv1 - batch_norm1 - leaky_relu1 - pool1
        with tf.variable_scope('layer1'):
            d['conv1'] = conv_layer(X_input, 3, 1, 32, padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer2'):
            d['conv2'] = tf.layers.separable_conv2d(d['pool1'], 64, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer3'):
            d['conv3'] = tf.layers.separable_conv2d(d['pool2'], 128, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer5'):
            d['conv5'] = tf.layers.separable_conv2d(d['leaky_relu4'], 128, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer6'):
            d['conv6'] = tf.layers.separable_conv2d(d['pool5'], 256, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer8'):
            d['conv8'] = tf.layers.separable_conv2d(d['leaky_relu7'], 256, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer9'):
            d['conv9'] = tf.layers.separable_conv2d(d['pool8'], 512, (3,3), padding='SAME',
                                                    use_bias=False)            
        ...
        with tf.variable_scope('layer11'):
            d['conv11'] = tf.layers.separable_conv2d(d['leaky_relu10'], 512, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer13'):
            d['conv13'] = tf.layers.separable_conv2d(d['leaky_relu12'], 512, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer14'):
            d['conv14'] = tf.layers.separable_conv2d(d['pool13'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer16'):
            d['conv16'] = tf.layers.separable_conv2d(d['leaky_relu15'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)            
        ...
        with tf.variable_scope('layer18'):
            d['conv18'] = tf.layers.separable_conv2d(d['leaky_relu17'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer19'):
            d['conv19'] = tf.layers.separable_conv2d(d['leaky_relu18'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer20'):
            d['conv20'] = tf.layers.separable_conv2d(d['leaky_relu19'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)
        ...
        with tf.variable_scope('layer22'):
            d['conv22'] = tf.layers.separable_conv2d(d['concat21'], 1024, (3,3), padding='SAME',
                                                    use_bias=False)
