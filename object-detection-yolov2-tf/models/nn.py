...
import numpy as np
from models.layers import conv_layer, max_pool, fc_layer, batchNormalization, depth_point_layer
...
class YOLO(DetectNet):
    ...
    def _build_model(self, **kwargs):
        ...
        with tf.variable_scope('layer2'):
            d['conv2'] = depth_point_layer(d['pool1'], 3, 1, 64,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer3'):
            d['conv3'] = depth_point_layer(d['pool2'], 3, 1, 128,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer5'):
            d['conv5'] = depth_point_layer(d['leaky_relu4'], 3, 1, 128,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer6'):
            d['conv6'] = depth_point_layer(d['pool5'], 3, 1, 256,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer8'):
            d['conv8'] = depth_point_layer(d['leaky_relu7'], 3, 1, 256,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer9'):
            d['conv9'] = depth_point_layer(d['pool8'], 3, 1, 512,
                                    padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer11'):
            d['conv11'] = depth_point_layer(d['leaky_relu10'], 3, 1, 512,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer13'):
            d['conv13'] = depth_point_layer(d['leaky_relu12'], 3, 1, 512,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer14'):
            d['conv14'] = depth_point_layer(d['pool13'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer16'):
            d['conv16'] = depth_point_layer(d['leaky_relu15'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer18'):
            d['conv18'] = depth_point_layer(d['leaky_relu17'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer19'):
            d['conv19'] = depth_point_layer(d['leaky_relu18'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer20'):
            d['conv20'] = depth_point_layer(d['leaky_relu19'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
        ...
        with tf.variable_scope('layer22'):
            d['conv22'] = depth_point_layer(d['concat21'], 3, 1, 1024,
                                     padding='SAME', use_bias=False, weights_stddev=0.01)
